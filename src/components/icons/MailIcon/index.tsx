...
const MailIcon = ({ width = 24 }) => {
  return (
    <svg width={width} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M16 9V13.5C16 14.8807 17.1193 16 18.5 16V16C19.8807 16 21 14.8807 21 13.5V12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
